    ...
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-white">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-display font-extrabold tracking-tight text-primary-900">
              ScholarLog
            </h1>
            ...
            <div className="flex gap-4">
              <Link to="/register">
                <Button variant="primary" className="text-base px-8 py-6">
                  Get Started
                </Button>
              </Link>
              <Link to="/login">
          ...
          <motion.div 
            ...
            className="flex-1 w-full max-w-xl bg-white rounded-2xl shadow-lg p-6 border border-primary-100"
          >
      ...
      <div className="bg-gradient-to-b from-white to-primary-50 py-16">
        <div className="container mx-auto px-4">
          <motion.h2 
            ...
            transition={{ duration: 0.5 }}
            className="text-3xl font-display font-bold text-center mb-12 text-primary-900"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-primary-100"
              >
                <div className="text-primary-600 mb-4">
                  {feature.icon}
                </div>
                <h3 className="text-lg font-display font-semibold mb-2 text-primary-900">{feature.title}</h3>
      ...
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        >
          <h2 className="text-3xl font-display font-bold mb-4 text-primary-900">Ready to Take Control of Your Academic Journey?</h2>
